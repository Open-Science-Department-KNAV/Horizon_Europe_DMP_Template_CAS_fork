...
This template is available through [FAIR Wizard Registry](https://registry.fair-wizard.com/templates).

## Changelog

### 2.0.9 & 2.0.10

- Fixed marcro for ASEP integration
- released 2025-10-22
...
- Updated according to fw:common-horizon-europe-dmp:1.14.0
...
- Adjusted to template metamodel version 13 (released in v4.3.0)
...
- Adjusted to template metamodel version 12 (released in v4.1.0)
...
- Adjusted to template metamodel version 11 (released in v3.20.0)
...
- Adjusted to template metamodel version 10 (released in v3.12.0)

### 1.1.0

- Adjusted to template metamodel version 9 (released in v3.10.0)
